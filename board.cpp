...
void Board::loadPosition(QString fen){
    ...
    ushort initialGameState = (whiteCastle | blackCastle | epState);
...
void Board::unmakeMove(Move &move, bool inSearch){
    ...
    int capturedPieceType = (currentGameState >> 8) & 63;
    ...
    fiftyMoveCounter = (int) (currentGameState >> 14);
...
void Board::Initialize(){
    ...
    knights[0] = new PieceList(10);
    pawns[0] = new PieceList(8);
    rooks[0] = new PieceList(10);
    bishops[0] = new PieceList(10);
    queens[0] = new PieceList(9);

    knights[1] = new PieceList(10);
    pawns[1] = new PieceList(8);
    rooks[1] = new PieceList(10);
    bishops[1] = new PieceList(10);
    queens[1] = new PieceList(9);
