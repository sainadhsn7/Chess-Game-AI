...
PrecomputedMoveData::PrecomputedMoveData() {
    ...
    for (int squareIndex = 0; squareIndex < 64; squareIndex++) {
        ...
        kingAttackBitboards[squareIndex] = knightAttackBitboards[squareIndex] = 0;
        pawnAttackBitboards[squareIndex][0] = pawnAttackBitboards[squareIndex][1] = 0;
        rookMoves[squareIndex] = bishopMoves[squareIndex] = 0;
